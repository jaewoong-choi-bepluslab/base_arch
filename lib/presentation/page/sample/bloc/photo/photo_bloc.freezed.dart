...
abstract class $PhotoStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({PhotoStatus status, List<Photo> photos});
}
...
/// @nodoc
class __$$_PhotoStateCopyWithImpl<$Res>
    extends _$PhotoStateCopyWithImpl<$Res, _$_PhotoState>
...
class _$_PhotoState implements _PhotoState {
  _$_PhotoState(
      {this.status = PhotoStatus.initail,
...
abstract class _PhotoState implements PhotoState {
  factory _PhotoState({final PhotoStatus status, final List<Photo> photos}) =
      _$_PhotoState;
